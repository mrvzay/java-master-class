...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // This is case, Integers array will have 10 elements.
...
//        newArray = new int[] {5, 4, 3, 2, 1};
        ...
        System.out.println();
        System.out.println(Arrays.toString(newArray)); // Hole array printing
        Object objectVariable = newArray;
        if (objectVariable instanceof int[] ) {
            System.out.println("objectVariable is really an int array");
        }

        // Everything is passing in object classes and types more...
